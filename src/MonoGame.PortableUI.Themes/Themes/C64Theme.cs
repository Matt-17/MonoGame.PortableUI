...
/// <summary>
///     Commodore 64: the bright BASIC-prompt blue with white frames and green/yellow accents.
///     Unlike the palette-derived themes, this one is a fully hand-built flat theme — kept
///     exactly as the original demo theme that defined the C64 look.
/// </summary>
public static class C64Theme
{
